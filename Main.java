...
class Roster {
    ...
    final static String[] STUDENTS = {
        "Aisha", "Benjamin", "Chen", "Dalia", "Edward", "Fatima", "George", "Hiroshi", "Imran",
        "Jasmine", "Khalid", "Ling", "Mohammed", "Nadia", "Oscar", "Priya", "Qasim", "Rahul",
        "Sammy", "Tara", "Umar", "Vijay", "Wei", "Xiu", "Yara", "Zainab"
    };
    
    // TODO Create a new Stack

    public void load() {
    	// TODO iterate over STUDENTS, adding each student to your new Stack
    }
    
    public void reverse() {
    	// TODO print out and remove each Student name from your Stack
    }
}
